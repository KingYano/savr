<template>
  <Card class="balance-card" :class="[isDarkMode ? 'bg-[#1A1A1A] border-white/10' : 'bg-white border border-slate-200']">
    <CardContent class="p-6">
      <div class="space-y-4">
        ...
        <div class="hidden md:grid grid-cols-3 gap-4 pt-2 border-t" :class="isDarkMode ? 'border-white/10' : 'border-slate-200'">
          <div class="space-y-1">
            <div class="text-sm" :class="isDarkMode ? 'text-white/60' : 'text-slate-600'">
              Entrées
            </div>
        ...
        <div class="md:hidden flex flex-col space-y-3 pt-2 border-t" :class="isDarkMode ? 'border-white/10' : 'border-slate-200'">
